...
I had recently saw a post of [@Gingfacekillah](https://x.com/Gingfacekillah) on X where he suggested to look at the over/under markets just like a stock option with a strike price (the line). I was not sure how or why but with the help of ChatGPT I decided to look into it, specifically in european football market.
